...
public class Settings {
    ...
    public static final int MAX_PLANT_ON_ONE_CELL = 500;
    public static final int GROW_PLANT_PER_DAY = 250;
    ...
    public static final double LOSS_SATIETY_PER_DAY = 0.2;
    ...
    public enum AnimalType {
        ...
        BOA (15., 15, 1, 3., Boa.class, "\uD83D\uDC0D"),
        FOX (8., 15, 2, 2., Fox.class, "\uD83E\uDD8A"),
        BEAR (500., 5, 2, 80., Bear.class, "\uD83D\uDC3B"),
        EAGLE (6., 15, 3, 1., Eagle.class, "\uD83E\uDD85"),
        HORSE (400., 20, 4, 60., Horse.class, "\uD83D\uDC0E"),
        DEER (300., 20, 4, 50., Deer.class, "\uD83E\uDD8C"),
        RABBIT (2., 300, 2, .45, Rabbit.class, "\uD83D\uDC07"),
        MOUSE (.05, 700, 1, .01, Mouse.class, "\uD83D\uDC01"),
        GOAT (60., 200, 3, 10., Goat.class, "\uD83D\uDC10"),
        SHEEP (70., 200, 3, 15., Sheep.class, "\uD83D\uDC11"),
